...
checklogin = () =>
  new Promise((resolve, reject) => {
    $("body").prepend(
      `<div id="loading-screen" class="loader-container"><div class="loader-ring"><div data-loader-div1></div><div data-loader-div2></div><div data-loader-div3></div><div data-loader-div4></div></div></div>`
    );
    if (typeof pyc === "undefined") {
      ...
      setTimeout(() => {
        $("#loading-screen").append(
          `<div style="margin-top:10px">Session Expired. You will be redirected to login page.</div>`
        );
      }, 1000);
